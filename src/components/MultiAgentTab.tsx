...
export default function MultiAgentTab() {
  ...
  return (
    <div className="space-y-10 max-w-5xl">
      <div>
        <h2 className="text-2xl font-bold text-[#FAFAFA]">4-Agent Autonomous Multi-Agent Pipeline</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {agents.map((ag, idx) => (
          <div
            key={ag.id}
            className="bg-[#161B22] p-6 rounded-2xl border border-[#242D3D] flex flex-col justify-between card-hover relative overflow-hidden"
          >
            <div
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-base font-bold text-[#FAFAFA]">{ag.name}</h3>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-[#242D3D]">
                <th className="text-left py-3 px-4 text-[#8B949E] font-semibold">Subsystem</th>
                <th className="text-left py-3 px-4 text-[#8B949E] font-semibold">Demo Sandbox</th>
                <th className="text-left py-3 px-4 text-[#8B949E] font-semibold">Production at Scale</th>
                <th className="text-left py-3 px-4 text-[#8B949E] font-semibold">SLA / Latency</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#242D3D]/50 text-[#C9D1D9]">
              <tr>
                <td className="py-3 px-4 font-semibold text-[#FAFAFA]">Event Ingestion</td>
                <td className="py-3 px-4 text-[#8B949E]">POST /api/recover</td>
                <td className="py-3 px-4 text-[#388BFD]">Apache Kafka Event Stream</td>
                <td className="py-3 px-4 font-mono text-[#2EA043]">p99 &lt; 8ms</td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-semibold text-[#FAFAFA]">Multi-Agent Pipeline</td>
                <td className="py-3 px-4 text-[#8B949E]">TypeScript Orchestrator</td>
                <td className="py-3 px-4 text-[#388BFD]">Distributed Go / Rust Microservices (K8s)</td>
                <td className="py-3 px-4 font-mono text-[#2EA043]">p99 &lt; 15ms</td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-semibold text-[#FAFAFA]">AI Reasoning (LLM)</td>
                <td className="py-3 px-4 text-[#8B949E]">Claude API + 18 Pattern Cache</td>
                <td className="py-3 px-4 text-[#388BFD]">Redis Embeddings + Async Batch Claude</td>
                <td className="py-3 px-4 font-mono text-[#2EA043]">&lt; 1ms (Cached)</td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-semibold text-[#FAFAFA]">Nudge Dispatch</td>
                <td className="py-3 px-4 text-[#8B949E]">Device Simulator Drawer</td>
                <td className="py-3 px-4 text-[#388BFD]">Gupshup (WhatsApp) + Karix (SMS) + APNs/FCM</td>
                <td className="py-3 px-4 font-mono text-[#2EA043]">Sub-30s Dispatch</td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-semibold text-[#FAFAFA]">Analytics & Audit</td>
                <td className="py-3 px-4 text-[#8B949E]">In-Memory Recharts</td>
                <td className="py-3 px-4 text-[#388BFD]">ClickHouse + Apache Pinot + Superset</td>
                <td className="py-3 px-4 font-mono text-[#2EA043]">Real-time OLAP</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="bg-gradient-to-r from-[#0D2847] to-[#0A192F] p-6 rounded-2xl border border-[#1E3A5F] flex items-center justify-between flex-wrap gap-4">
        <div>
          <h4 className="text-sm font-bold text-[#F0F6FC]">Razorpay AI Builder Internship — Track 3: AI Revenue Recovery</h4>
          <p className="text-xs text-[#7EB6F0] mt-0.5">
            Designed and built with Next.js 16 (App Router), React 19, TypeScript, Recharts, and Claude AI.
          </p>
        </div>
        <span className="text-xs font-mono bg-[#388BFD]/20 text-[#7EB6F0] px-3 py-1.5 rounded-lg border border-[#388BFD]/30">
